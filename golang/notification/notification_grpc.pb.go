...
const (
	...
	NotificationService_SendTelegramNotification_FullMethodName = "/notification.v1.NotificationService/SendTelegramNotification"
)
...
type NotificationServiceClient interface {
	...
	SendTelegramNotification(ctx context.Context, in *SendTelegramRequest, opts ...grpc.CallOption) (*SendTelegramResponse, error)
}
...
func (c *notificationServiceClient) SendTelegramNotification(ctx context.Context, in *SendTelegramRequest, opts ...grpc.CallOption) (*SendTelegramResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SendTelegramResponse)
	err := c.cc.Invoke(ctx, NotificationService_SendTelegramNotification_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NotificationServiceServer interface {
	...
	SendTelegramNotification(context.Context, *SendTelegramRequest) (*SendTelegramResponse, error)
...
func (UnimplementedNotificationServiceServer) SendTelegramNotification(context.Context, *SendTelegramRequest) (*SendTelegramResponse, error) {
...
func _NotificationService_SendTelegramNotification_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendTelegramRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NotificationServiceServer).SendTelegramNotification(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NotificationService_SendTelegramNotification_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotificationServiceServer).SendTelegramNotification(ctx, req.(*SendTelegramRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var NotificationService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _NotificationService_SendTelegramNotification_Handler,
		},
	},
