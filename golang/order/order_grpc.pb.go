...
type OrderServiceClient interface {
	...
	ConfirmComplete(ctx context.Context, in *ConfirmCompleteRequest, opts ...grpc.CallOption) (*ConfirmCompleteResponse, error)
...
func (c *orderServiceClient) MarkComplete(ctx context.Context, in *MarkCompleteRequest, opts ...grpc.CallOption) (*MarkCompleteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MarkCompleteResponse)
	err := c.cc.Invoke(ctx, OrderService_MarkComplete_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderServiceClient) ConfirmComplete(ctx context.Context, in *ConfirmCompleteRequest, opts ...grpc.CallOption) (*ConfirmCompleteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ConfirmCompleteResponse)
	err := c.cc.Invoke(ctx, OrderService_ConfirmComplete_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderServiceClient) DisputeOrder(ctx context.Context, in *DisputeOrderRequest, opts ...grpc.CallOption) (*DisputeOrderResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DisputeOrderResponse)
	err := c.cc.Invoke(ctx, OrderService_DisputeOrder_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServiceServer interface {
	...
	ConfirmComplete(context.Context, *ConfirmCompleteRequest) (*ConfirmCompleteResponse, error)
...
func (UnimplementedOrderServiceServer) MarkComplete(context.Context, *MarkCompleteRequest) (*MarkCompleteResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method MarkComplete not implemented")
}
func (UnimplementedOrderServiceServer) ConfirmComplete(context.Context, *ConfirmCompleteRequest) (*ConfirmCompleteResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ConfirmComplete not implemented")
}
func (UnimplementedOrderServiceServer) DisputeOrder(context.Context, *DisputeOrderRequest) (*DisputeOrderResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DisputeOrder not implemented")
}
...
func _OrderService_MarkComplete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MarkCompleteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServiceServer).MarkComplete(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderService_MarkComplete_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).MarkComplete(ctx, req.(*MarkCompleteRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _OrderService_ConfirmComplete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ConfirmCompleteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServiceServer).ConfirmComplete(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderService_ConfirmComplete_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).ConfirmComplete(ctx, req.(*ConfirmCompleteRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _OrderService_DisputeOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DisputeOrderRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServiceServer).DisputeOrder(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderService_DisputeOrder_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).DisputeOrder(ctx, req.(*DisputeOrderRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OrderService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _OrderService_MarkComplete_Handler,
		},
		{
			MethodName: "ConfirmComplete",
			Handler:    _OrderService_ConfirmComplete_Handler,
		},
		{
			MethodName: "DisputeOrder",
			Handler:    _OrderService_DisputeOrder_Handler,
		},
		{
